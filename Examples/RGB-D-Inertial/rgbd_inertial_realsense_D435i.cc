...
int main(int argc, char **argv) {
...
#else
            std::chrono::high_resolution_clock::time_point time_Start_Process = std::chrono::high_resolution_clock::now();
#endif
    ...
    #else
            std::chrono::high_resolution_clock::time_point t_Start_Resize = std::chrono::high_resolution_clock::now();
    #endif
#endif
    ...
    #else
            std::chrono::high_resolution_clock::time_point t_End_Resize = std::chrono::high_resolution_clock::now();
    #endif
    ...
    #else
        std::chrono::high_resolution_clock::time_point t_Start_Track = std::chrono::high_resolution_clock::now();
    #endif
#endif
    ...
    #else
        std::chrono::high_resolution_clock::time_point t_End_Track = std::chrono::high_resolution_clock::now();
    #endif

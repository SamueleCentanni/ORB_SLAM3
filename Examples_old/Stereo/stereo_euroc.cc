...
{  
    ...
    #else
            std::chrono::high_resolution_clock::time_point t_Start_Rect = std::chrono::high_resolution_clock::now();
    #endif
#endif
    ...
    #else
            std::chrono::high_resolution_clock::time_point t_End_Rect = std::chrono::high_resolution_clock::now();
    #endif
